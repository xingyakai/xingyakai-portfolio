...
export const workSeries: WorkSeries[] = [
  ...
  // ── 人像系列 ─────────────────────────────────────────────────
  {
    ...
    images: [
      { src: '/images/liuli/0241cf56f62024cc2955832ee1940d64.jpg', title: '水下凝息', positivePrompt: '水下人像特写，一位东方女性的面孔沉浸于清透的碧绿色水中，阳光自水面折射化作粼粼波纹光斑洒落脸庞；她双眼半睁半阖神情宁静，周围漂浮着几片绿叶与晶莹气泡，皮肤水润泛着光泽，发丝随水流温柔飘散；色调清透碧绿并晕染金色光晕，光影如梦，气泡与水纹质感真实细腻；超写实电影级人像摄影，微距浅景深，柔和折射光，85mm，8K超高清', negativePrompt: NEG_PORTRAIT },
      { src: '/images/liuli/308857b8de9b203096942a9860ad253e.jpg', title: '深海仰望', positivePrompt: '水下仰拍人像，一位蓝眸少女的侧脸浸于深蓝海水之中，仰视上方的光源；水面光线在她脸上投射出绚烂的折射纹路，橙色花瓣与气泡在蓝色水体中缓缓漂浮，卷发四散飘扬；肤色白皙温润，蓝色瞳孔清澈明亮，色调以深蓝与暖橙形成强烈冷暖对比；奇幻唯美写实风格，仰角构图，电影级光影渲染，浅景深，细腻质感，8K细节', negativePrompt: NEG_PORTRAIT },
      { src: '/images/liuli/3cbd11522f6e496d7daad90c02f97ac4.jpg', title: '雏菊漂梦', positivePrompt: '带插画质感的水下人像，一位少女的面孔浸于浅蓝色水中，蓝灰色眸子清澈灵动；白色雏菊花朵与青翠水草环绕四周，细小水珠点缀脸颊，湿润刘海贴额，红唇微微开启；色调清冷蓝绿并透出粉白，融合二次元插画与超写实的独特风格，光影柔和梦幻，细节极致；唯美水下人像，中近景浅景深，柔光折射，通透质感，8K分辨率', negativePrompt: NEG_PORTRAIT },
      { src: '/images/liuli/3cfbf7feae86c42841ba1607dfb5d3c6.jpg', title: '蝶梦沉眠', positivePrompt: '奇幻水下人像特写，一位少女闭眸静静沉浸于深色水中，数只彩色荧光蝴蝶在她四周飞舞漂浮；水面光线折射出霓虹蓝紫色的光带，皮肤泛着淡淡金属光泽质感，晶莹气泡剔透上升；色调以深蓝、霓虹紫、橘粉为主，超现实奇幻，光影迷离绚烂，材质通透梦幻；超现实奇幻艺术人像，微距浅景深，霓虹体积光，电影级渲染，8K超清', negativePrompt: NEG_PORTRAIT },
      { src: '/images/liuli/447aefd0f939d224dd36319cb75fb09b.jpg', title: '虹光倾城', positivePrompt: '超近距离女性面孔特写，一双摄人心魄的绿色眸子直视镜头，脸部覆盖着绚烂的彩虹折射光斑；橙、黄、金、蓝交织的棱镜光线在皮肤上勾勒出迷幻图案，湿润卷发凌乱飘散；皮肤质感极致真实并泛着水润光泽，色调以暖金橙为主并辅以彩虹光晕，光影梦幻迷离；超写实特写人像，微距极浅景深，棱镜彩虹光，细腻毛孔质感，8K超高清', negativePrompt: NEG_PORTRAIT },
      { src: '/images/liuli/eb9bbdd1fffa3c9fe3e65154c79e7103.jpg', title: '泡影浮光', positivePrompt: '水下人像特写，一位棕发少女的面孔浸于暗色水中，大小不一的透明气泡漂浮四周并映出橙红色光斑倒影；水面折射化作白色波纹光影覆盖脸颊，她的眼神空灵略带迷离，红棕色发丝随水流缓缓散开；皮肤质感细腻真实，色调深沉暗调并点缀暖橙光斑，光影朦胧诗意；超写实电影级人像，微距浅景深，柔和折射光，通透质感，8K细节', negativePrompt: NEG_PORTRAIT },
    ],
  },
  {
    slug: 'suyan',
